		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/manages/products" method="POST" enctype="multipart/form-data">
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <sf:form id="categoryForm" class="form-horizontal" modelAttribute="category" action="${contextRoot}/manages/category" method="POST">
	        	<div class="form-group">
       			...
       			<div class="form-group">
							...
							<div class="col-md-8">
								<sf:textarea cols="" rows="5" path="description" id="category_descripton" class="form-control"/>
